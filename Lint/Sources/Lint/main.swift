// ===----------------------------------------------------------------------===//
//
// This source file is part of the swift-coproduct-primitives open source project
//
// Copyright (c) 2026 Coen ten Thije Boonkkamp and the swift-coproduct-primitives project authors
